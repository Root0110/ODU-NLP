...
def domain_specific(dir,domains):
    ...
    for d in domains:
        if d == 'Overall':
            ...
            num_of_files = 10
        scores = kfold_bilstm_elmo(dir, d, d, num_of_files,num_of_files)
        print('======== {}'.format(d))
        f1_te.append(scores[0])
        recall_te.append(scores[1])
        precision_te.append(scores[2])
    plot_scores(f1_te, recall_te, precision_te, domains, 'BilSTM-Elmo Performance')
